from data.models import __congress__
...
def add_name():
    # Current congress models
    r = ReadFromDatabase('models', 'congress_map_trimmed')
    ...
    Database('models').remove_collection('congress_map_trimmed_with_name')
    w = WriteToDatabase('models', 'congress_map_trimmed_with_name')
    w.collection.insert_many(tmp_stuff)
    # print(models[0])

def add_party():
    r = ReadFromDatabase('models', 'congress_map_trimmed_with_name')
    data = r.read_raw_data()
    ...
    Database('models').remove_collection('current_congress_with_data')
    WriteToDatabase('models', 'current_congress_with_data').collection.insert_many(new_col)
...
if __name__ == "__main__":
    ...
    a = ReadFromDatabase('models', 'current_congress_with_data').read_raw_data()
    for i in a:
        print(i)
    # models = r.read_raw_data()
    # for i in models:
    #     print(i)
